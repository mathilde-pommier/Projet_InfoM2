...
public class ChefAtelier extends Personnel {
    ...
    public ChefAtelier(String idChef_atelier, String Nom_chef_atelier, String Prenom_chef_atelier, String nom_atelier, String motdepasse_chef_atelier){
        super(idChef_atelier,Nom_chef_atelier,Prenom_chef_atelier, motdepasse_chef_atelier);
        this.nom_atelier=nom_atelier;
    }
    
    public ChefAtelier(String idChef_atelier, String Nom_chef_atelier, String Prenom_chef_atelier, String motdepasse_chef_atelier){
        super(idChef_atelier,Nom_chef_atelier,Prenom_chef_atelier, motdepasse_chef_atelier);
    }
